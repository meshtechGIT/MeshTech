...
*Recommended Scoop install for Windows* <br/>
*Recommended Hugo Extended Version* <br/>
Documentation: https://gohugo.io/getting-started/installing/ <br/>

### Running site on local host:
1. Once hugo is installed on your machine, clone the repository to your desired path.
2. Using a terminal (eg. powershell, git bash) navigate to the directory the folder was cloned to.
